...
// void collision_grid_check_circles(SpatialGrid* grid, Circle** circle_array)
// {
//     for(int i = 0; i < grid->circle_count; i++)
//     {
//         CircleList nearby;
//         grid_get_nearby_circles(grid, circle_array[i], &nearby);

//         CircleNode* current = nearby.head;
//         while(current != NULL)
//         {
//             if(current->circle != circle_array[i])
//             {
//                 check_collision(current->circle, circle_array[i]);
//             }
//         }
//     }
// }
